...
@section('description', 'Get in touch with Kitsuneoni via Telegram or email. We typically respond within 24 hours.')
@section('og_title', 'Contact Kitsuneoni')
@section('og_description', 'Get in touch with Kitsuneoni via Telegram or email.')
...
<section class="pt-28 pb-20 min-h-screen bg-background">
    <div class="max-w-[1440px] mx-auto px-6 lg:px-12">
        ...
        <div class="grid sm:grid-cols-2 gap-6 max-w-3xl mx-auto">
            <a href="{{ config('site.contact.telegram') }}" target="_blank" class="group border border-border bg-card rounded-xl p-8 text-center hover:border-primary/50 transition-all duration-300">
            ...
            <a href="mailto:{{ config('site.contact.email') }}" class="group border border-border bg-card rounded-xl p-8 text-center hover:border-primary/50 transition-all duration-300">
                ...
                <p class="text-sm text-muted-foreground">{{ config('site.contact.email') }}</p>
            </a>
        </div>
