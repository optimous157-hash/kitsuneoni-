<?php $__env->startSection('title', 'Wishlist — Kitsuneoni'); ?>
<?php $__env->startSection('description', 'Save your favorite Kitsuneoni blades and collectibles to your wishlist for later.'); ?>
<?php $__env->startSection('og_title', 'Wishlist — Kitsuneoni'); ?>
<?php $__env->startSection('og_description', 'Save your favorite Kitsuneoni blades and collectibles to your wishlist.'); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\OPTIMOUS\OneDrive\Documents\yamagata\yamagata-oni\resources\views\shop\wishlist.blade.php ENDPATH**/ ?>