...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Admin'); ?> — Kitsuneoni</title>
    ...
    <aside :class="sidebarOpen ? 'open' : ''" class="admin-sidebar">
        <div class="flex flex-col h-full">
            ...
            <nav class="flex-1 p-3 space-y-0.5 overflow-y-auto">
                <a href="<?php echo e(route('admin.dashboard')); ?>" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all duration-200 <?php echo e(request()->routeIs('admin.dashboard') ? 'bg-yamagata-red/10 text-yamagata-red' : 'text-yamagata-silver hover:text-white hover:bg-white/[0.03]'); ?>">
                ...
                <a href="<?php echo e(route('admin.products.index')); ?>" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all duration-200 <?php echo e(request()->routeIs('admin.products.*') ? 'bg-yamagata-red/10 text-yamagata-red' : 'text-yamagata-silver hover:text-white hover:bg-white/[0.03]'); ?>">
                ...
                <a href="<?php echo e(route('admin.categories.index')); ?>" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all duration-200 <?php echo e(request()->routeIs('admin.categories.*') ? 'bg-yamagata-red/10 text-yamagata-red' : 'text-yamagata-silver hover:text-white hover:bg-white/[0.03]'); ?>">
                ...
                <a href="<?php echo e(route('admin.orders.index')); ?>" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all duration-200 <?php echo e(request()->routeIs('admin.orders.*') ? 'bg-yamagata-red/10 text-yamagata-red' : 'text-yamagata-silver hover:text-white hover:bg-white/[0.03]'); ?>">
                    ...
                    <span class="ml-auto px-1.5 py-0.5 text-[10px] font-bold bg-yamagata-red/20 text-yamagata-red rounded-md"><?php echo e($pendingOrdersCount); ?></span>
                    <?php endif; ?>
                </a>

                <a href="<?php echo e(route('admin.customers.index')); ?>" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all duration-200 <?php echo e(request()->routeIs('admin.customers.*') ? 'bg-yamagata-red/10 text-yamagata-red' : 'text-yamagata-silver hover:text-white hover:bg-white/[0.03]'); ?>">
                ...
                <a href="<?php echo e(route('admin.reviews.index')); ?>" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all duration-200 <?php echo e(request()->routeIs('admin.reviews.*') ? 'bg-yamagata-red/10 text-yamagata-red' : 'text-yamagata-silver hover:text-white hover:bg-white/[0.03]'); ?>">
                    <svg class="w-[18px] h-[18px]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z"/></svg>
                    Reviews
                </a>

                <a href="<?php echo e(route('admin.contacts.index')); ?>" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all duration-200 <?php echo e(request()->routeIs('admin.contacts.*') ? 'bg-yamagata-red/10 text-yamagata-red' : 'text-yamagata-silver hover:text-white hover:bg-white/[0.03]'); ?>">
                ...
                <a href="<?php echo e(route('admin.content.sections')); ?>" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all duration-200 <?php echo e(request()->routeIs('admin.content.sections') ? 'bg-yamagata-red/10 text-yamagata-red' : 'text-yamagata-silver hover:text-white hover:bg-white/[0.03]'); ?>">
                    <svg class="w-[18px] h-[18px]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M4 5a1 1 0 011-1h14a1 1 0 011 1v2a1 1 0 01-1 1H5a1 1 0 01-1-1V5zM4 13a1 1 0 011-1h6a1 1 0 011 1v6a1 1 0 01-1 1H5a1 1 0 01-1-1v-6zM16 13a1 1 0 011-1h2a1 1 0 011 1v6a1 1 0 01-1 1h-2a1 1 0 01-1-1v-6z"/></svg>
                    Page Sections
                </a>

                <a href="<?php echo e(route('admin.content.faqs')); ?>" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all duration-200 <?php echo e(request()->routeIs('admin.content.faqs') ? 'bg-yamagata-red/10 text-yamagata-red' : 'text-yamagata-silver hover:text-white hover:bg-white/[0.03]'); ?>">
                ...
                <a href="<?php echo e(route('admin.newsletter.index')); ?>" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all duration-200 <?php echo e(request()->routeIs('admin.newsletter.*') ? 'bg-yamagata-red/10 text-yamagata-red' : 'text-yamagata-silver hover:text-white hover:bg-white/[0.03]'); ?>">
                    <svg class="w-[18px] h-[18px]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg>
                    Newsletter
                </a>
                ...
                <a href="<?php echo e(route('admin.settings.index')); ?>" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all duration-200 <?php echo e(request()->routeIs('admin.settings.*') ? 'bg-yamagata-red/10 text-yamagata-red' : 'text-yamagata-silver hover:text-white hover:bg-white/[0.03]'); ?>">
            ...
            <div class="p-3 border-t border-yamagata-graphite/40">
                <div class="flex items-center gap-3 px-2 py-2">
                    <img src="<?php echo e(auth()->user()->avatar_url); ?>" class="w-8 h-8 rounded-lg object-cover ring-2 ring-yamagata-graphite/50" alt="">
                    <div class="flex-1 min-w-0">
                        <p class="text-sm font-medium text-white truncate"><?php echo e(auth()->user()->name); ?></p>
                        <p class="text-[11px] text-yamagata-steel"><?php echo e(ucfirst(auth()->user()->role)); ?></p>
                    </div>
        ...
        <header class="sticky top-0 z-30 bg-[#080808]/80 backdrop-blur-xl border-b border-yamagata-graphite/30">
            <div class="flex items-center justify-between px-6 py-3">
                ...
                <div class="flex items-center gap-2">
                    <a href="<?php echo e(route('home')); ?>" target="_blank" class="flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium text-yamagata-silver hover:text-white rounded-lg hover:bg-white/[0.03] transition-all">
...
<?php /**PATH C:\Users\OPTIMOUS\OneDrive\Documents\yamagata\yamagata-oni\resources\views\admin\layouts\admin.blade.php ENDPATH**/ ?>