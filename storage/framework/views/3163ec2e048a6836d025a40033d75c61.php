...
<div class="space-y-6">
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="text-yamagata-silver text-sm mt-0.5"><?php echo e(number_format($reviews->total())); ?> total reviews</p>
        </div>
    </div>
        ...
        <div class="overflow-x-auto">
            ...
            <table class="admin-table">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            <p class="text-white text-sm font-medium"><?php echo e($review->customer_name); ?></p>
                            <p class="text-xs text-yamagata-steel"><?php echo e($review->customer_country); ?></p>
                        </td>
                        <td class="text-sm"><?php echo e($review->product->name ?? '—'); ?></td>
                        <td>
                            <div class="flex gap-0.5">
                                <?php for($i = 1; $i <= 5; $i++): ?>
                                <svg class="w-3.5 h-3.5 <?php echo e($i <= $review->rating ? 'text-yamagata-gold' : 'text-yamagata-graphite'); ?>" fill="currentColor" viewBox="0 0 20 20"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/></svg>
                                <?php endfor; ?>
                            </div>
                        </td>
                        <td class="text-sm max-w-[200px] truncate"><?php echo e($review->title ?: '—'); ?></td>
                        <td>
                            <span class="admin-badge <?php echo e($review->is_approved ? 'admin-badge-active' : 'admin-badge-pending'); ?>">
                        ...
                        <td class="text-right">
                            <div class="flex items-center justify-end gap-2">
                                ...
                                <?php endif; ?>
                                <form action="<?php echo e(route('admin.reviews.destroy', $review)); ?>" method="POST" onsubmit="return confirm('Delete this review?')">
...
<?php echo $__env->make('admin.layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\OPTIMOUS\OneDrive\Documents\yamagata\yamagata-oni\resources\views\admin\reviews\index.blade.php ENDPATH**/ ?>